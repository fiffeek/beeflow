...
inputs = {
  ...
  dag_parsing_processor_package_absolute_path = "${get_repo_root()}/dist/src.python.beeflow.lambdas.dag_parsing_processor/package.zip"
  dag_parsing_processorpackage_filename       = "src.python.beeflow.lambdas.dag_parsing_processor.zip"
