...
dependency "batch_executor" {
  config_path = "../batch-executor"
}
...
inputs = {
  ...
  batch_executor_sqs = {
    arn : dependency.batch_executor.outputs.executor_sqs_arn,
    id : dependency.batch_executor.outputs.executor_sqs_id,
  }
